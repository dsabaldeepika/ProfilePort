    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProfilePort.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(ProfilePort.Data.ApplicationDbContext context)
        {
            ...
            context.Profiles.AddOrUpdate(
              p => p.ProfileId,
              new Profile { IsLookingForJob = true, Sex = "Male", PicFile = "Pic1", DateOfBirth = new DateTime(1985, 7, 5), UserId = "Zango", },
            ...
            p => p.Id,
            new Note { NoteContent = " THis is a Real Note", Title = "My note", UserId = "Zango", },
        ...
        new Message { UserId = "Zango", From = "Sabal", To = "Prbal", ToId = "Prambo", FromId = "Zango", Subject = "Message", Content = "Hello Hello", DateCreated = DateTime.Now, DateUpdated = DateTime.Now, DateRead = DateTime.Now, });
            context.SaveChanges();
        ...
        new Message { UserId = "Prambo", Subject = "Message", Content = "Hello Hello", DateCreated = DateTime.Now, DateUpdated = DateTime.Now, DateRead = DateTime.Now, });
            ...
            context.Educations.AddOrUpdate(p => p.EducationId,
                new Education { FieldofStudy = "Science & Tech", Grade = 'A', School = "University Of Houston", UserId = "Zango", Activities = "Nothing",Description ="asedf", },
            new Education { FieldofStudy = "Business", Grade = 'A', School = "University Of Houston", UserId = "Zango", Activities = "Nothing", Description = "asedf", },
            new Education { FieldofStudy = "Technology", Grade = 'A', School = "University Of Houston", UserId = "Zango", Activities = "Nothing", Description = "asedf", });
            context.SaveChanges();
            ...
            context.ContactInfoes.AddOrUpdate(p => p.Id,
